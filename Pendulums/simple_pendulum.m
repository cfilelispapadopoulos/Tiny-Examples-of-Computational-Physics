% Not so simple pendulum with a bob, whose center of
% mass retains all mass. The bob it is depicted as a
% circle but does not interact with each surroundings.
% Equation: d^2 \theta /dt^2 = -g/l sin\theta
...
while time <= T_max
    % Kick (1/2)
    omega = omega + f(g,L,theta) * t_step / 2.0; 
    % Drift
